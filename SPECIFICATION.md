...
`createGame`, `joinGame`, `boardEvent` (incl. cosmetic `DRAG_START` / `DRAG_HOVER`), `clockPress`, `offerDraw`, `acceptDraw`, `rejectDraw`, `claimDraw`, `resign`, `rematchOffer`, `requestPgn`, `restorePosition`, `readyToContinue`.
