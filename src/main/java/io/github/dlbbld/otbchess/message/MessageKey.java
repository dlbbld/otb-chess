...
public enum MessageKey {
  ...
  ARBITER_RELEASED_PIECE_POSITION_CHANGE_PLAYER("arbiter.released_piece.position_change.player",
      MessageSeverity.ERROR),
  ARBITER_RELEASED_PIECE_POSITION_CHANGE_OPPONENT("arbiter.released_piece.position_change.opponent",
      MessageSeverity.ERROR),
  ...
  ARBITER_RELEASED_PIECE_FROM_POSITION_CHANGE_PLAYER("arbiter.released_piece.from.position_change.player",
      MessageSeverity.ERROR),
  ARBITER_RELEASED_PIECE_FROM_POSITION_CHANGE_OPPONENT("arbiter.released_piece.from.position_change.opponent",
      MessageSeverity.ERROR),
