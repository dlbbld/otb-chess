 ...
 *
 * @param type          the kind of obligation: must move own piece, must capture opponent piece, or must castle on a
 *                      specific side (FIDE 4.4.a).
 * @param square        the square of the primary touched piece (at the time of touch, in the position before the move).
 *                      For {@link TouchMoveType#CASTLING} this is the king's starting square.
 ...
 * @param toSquare      for {@link TouchMoveType#SPECIFIC_CAPTURE}, the square of the opponent piece that must be
 *                      captured. {@link Square#NONE} for the other types.
 * @param capturedPiece for {@link TouchMoveType#SPECIFIC_CAPTURE}, the opponent piece that must be captured.
 *                      {@link Piece#NONE} for the other types.
 */
